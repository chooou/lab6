...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convretView, ViewGroup parent){
            convretView = getLayoutInflater().inflate(view,parent,false);
            TextView name = convretView.findViewById(R.id.name);
            name.setText(data[position].name);
            ImageView imageView = convretView.findViewById(R.id.imageView);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] messageArray = new String[]{"訊息1","訊息2","訊息3","訊息5","訊息6"};
